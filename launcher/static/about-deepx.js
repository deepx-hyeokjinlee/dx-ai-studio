    ...
    el.innerHTML = `
      ...
      <div class="about-tech-block about-fade-in">
        ...
        <figure class="about-sdk-env-fig">
          <img class="about-sdk-env-a" src="/static/img/about/dx-allsuite-environments-t.png" alt="DX-AllSuite supported environments and integrations: DEEPX Developers, GitHub, AWS IoT Greengrass; Docker and local install" loading="lazy">
          <img class="about-sdk-env-b" src="/static/img/about/DXNN-SDK-풀스택-소프트웨어-아키텍처-다이어그램.png" alt="DXNN SDK full-stack software architecture diagram" loading="lazy">
        </figure>
        <div class="about-stats-row">
          ${t.sdk.stats.map(s => `
            <div class="about-stat-card">
